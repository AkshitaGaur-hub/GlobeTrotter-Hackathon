...
export default function Search() {
  ...
  const allResults = [
    ...
    { id: 5, title: 'Taj Mahal', location: 'Agra, India (Asia)', type: 'Historical', rating: 4.9, price: '$', image: 'https://images.unsplash.com/photo-1548013146-72479768bada?auto=format&fit=crop&w=800&q=80', description: 'An immense mausoleum of white marble, built in Agra by Mughal emperor Shah Jahan.', fullDetails: 'The Taj Mahal is an ivory-white marble mausoleum on the right bank of the river Yamuna in the Indian city of Agra. It was commissioned in 1632 by Mughal emperor Shah Jahan to house the tomb of his favourite wife, Mumtaz Mahal; it also houses the tomb of Shah Jahan himself. The tomb is the centrepiece of a 17-hectare (42-acre) complex, which includes a mosque and a guest house.' },
