  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/70 backdrop-blur-md p-4 animate-fade-in">
      <div className="bg-white dark:bg-slate-900 rounded-3xl p-8 max-w-md w-full shadow-2xl border border-slate-100 dark:border-slate-800 text-center relative overflow-hidden">
        ...
        <div className="relative mx-auto w-20 h-20 rounded-2xl bg-blue-600 p-0.5 mb-6 flex items-center justify-center">
          <div className="w-full h-full bg-white dark:bg-slate-900 rounded-[14px] flex items-center justify-center">
            <Compass className="w-10 h-10 text-blue-600 animate-[spin_6s_linear_infinite]" />
          </div>
        </div>
            ...
            return (
              <div
                ...
                className={`flex items-center gap-3 p-2.5 rounded-xl transition-all duration-300 ${
                  isCurrent
                    ? "bg-blue-50/80 border border-blue-200/80 text-brand-900 scale-[1.02]"
                    : isDone
